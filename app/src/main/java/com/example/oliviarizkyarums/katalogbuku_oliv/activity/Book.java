...
/**
 * Created by Olivia Rizky Arum S on 15/04/2017.
 */
public class Book implements Serializable {
    ...
    //constructor
    public Book(String pISBN, String book_title, String pBookAuthor, int pPublisherYear, String book_genre, String synopsis, int cover) {
        ISBN = pISBN;
        this.book_title = book_title;
        book_author = pBookAuthor;
        published_year = pPublisherYear;
