package com.example.oliviarizkyarums.katalogbuku_oliv;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerBook.addItemDecoration(new DividerItemDecoration(this, 0));
    ...
    private void prepareBookData() {
        ...
        book = new Book("9780439136365", "Harry Potter and The Prisioner of Azkaban", "J.K Rowling", 2001, "Fantasy, Thriller, Mystery", "This is some synopsis", R.drawable.hp_azkaban);
        bookList.add(book);
